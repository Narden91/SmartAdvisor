...
const ToolCard: React.FC<{
    ...
    <button
        onClick={onClick}
        className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 hover:border-cyan-500/70 hover:bg-slate-800 transition-all duration-300 text-left w-full h-full flex flex-col transform hover:-translate-y-1"
    >
        ...
        <p className="mt-4 text-slate-400 leading-relaxed flex-grow">{description}</p>
        <div className="mt-6 text-cyan-400 font-semibold flex items-center gap-2">
            <span>Utilizza Strumento</span>
