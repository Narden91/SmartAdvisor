...
const SalaryCalculator: React.FC<SalaryCalculatorProps> = ({ onBack }) => {
            ...
            <div className="max-w-7xl mx-auto">
                <header className="flex items-center justify-between gap-4 mb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Calcolatore Stipendio Netto</h1>
                            <p className="text-slate-400 mt-1 text-base">Dal Lordo al Netto con le regole 2025</p>
                        </div>
                    </div>
                    <button
                        onClick={onBack}
                ...
                <main className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    <div className="lg:col-span-2">
                        <form onSubmit={handleCalculate} className="bg-slate-800/60 backdrop-blur-sm p-6 rounded-2xl shadow-2xl border border-slate-700/80 space-y-5">
                            ...
                            <div>
                                <label htmlFor="ral" className="block text-sm font-medium text-slate-300 mb-1.5">Retribuzione Annua Lorda (RAL)</label>
                             ...
                             <div>
                                <label htmlFor="mensilita" className="block text-sm font-medium text-slate-300 mb-1.5">Numero Mensilità</label>
                             ...
                             <div>
                                <label htmlFor="contractType" className="block text-sm font-medium text-slate-300 mb-1.5">Tipo di Contratto</label>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="regione" className="block text-sm font-medium text-slate-300 mb-1.5">Regione Residenza</label>
                                ...
                                <div>
                                    <label htmlFor="addizionaleComunale" className="block text-sm font-medium text-slate-300 mb-1.5">Add. Comunale</label>
                                    <div className="relative">
                             ...
                             <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="figliACarico" className="block text-sm font-medium text-slate-300 mb-1.5">Figli a Carico (&lt;21)</label>
                                ...
                                <div>
                                     <label htmlFor="altriFamiliariACarico" className="block text-sm font-medium text-slate-300 mb-1.5">Altri Familiari</label>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        {results ? (
                           ...
                           <div className="flex flex-col justify-center items-center h-full min-h-[400px] bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 text-center border-2 border-dashed border-slate-700">
                                ...
                                <h2 className="text-2xl font-bold text-white">Il tuo stipendio, in chiaro</h2>
                                <p className="mt-2 max-w-sm text-slate-400">Inserisci i dati nel modulo per scoprire il tuo stipendio netto mensile e annuale.</p>
                           </div>
                        )}
                    </div>
                </main>
